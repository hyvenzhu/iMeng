package com.android.imeng.util.crash2email;
...
import com.android.imeng.util.MailUtil;
...
public class CrashMailProvider
{
    ...
    /** Mail Senders*/
    private List<MailUtil.MailInfo> fromEmailList = new ArrayList<MailUtil.MailInfo>();
    /** Mail receivers*/
     ...
     * @return
     */
    public MailUtil.MailInfo getMailInfo(String crashMsg)
    {
        ...
        MailUtil.MailInfo info = fromEmailList.get(index);
    ...
    private void loadSenderAndReceivers()
    {
        try
        {
            ...
            itemFrom.setElementListener(new ElementListener()
            {
                ...
                {
                    mailInfo = new MailUtil.MailInfo();
                }
            });
